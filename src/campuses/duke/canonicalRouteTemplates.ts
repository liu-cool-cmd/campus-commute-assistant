...
export const canonicalRouteTemplates: Record<string, CanonicalRouteStop[]> = {
  ...
  'TL-4': [
    ...
    { stopId: 'TL-99', name: 'Research Dr at Nanaline Duke Bldg (Northbound)', secondsFromStart: 540 },
    { stopId: 'TL-100', name: 'Circuit Dr at Circuit Lot (Westbound)', secondsFromStart: 600 },
    { stopId: 'TL-101', name: 'Circuit Drive at Circuit Lot Extension (Westbound)', secondsFromStart: 660 },
    ...
    { stopId: 'TL-109', name: 'LaSalle St at Belmont Apartments (Northbound)', secondsFromStart: 1140 },
  ],
  ...
  'TL-17': [
    ...
    { stopId: 'TL-162', name: 'Research Dr at Nanaline Duke Bldg (Northbound)', secondsFromStart: 300 },
    ...
    { stopId: 'TL-165', name: 'Research Dr at Erwin Rd (Research Drive Garage)', secondsFromStart: 480 },
    ...
    { stopId: 'TL-177', name: 'LaSalle St at Belmont Apartments (Northbound)', secondsFromStart: 1200 },
  ],
  ...
  'TL-13': [
    ...
    { stopId: 'TL-190', name: 'Morreene Rd at Campus Walk Ave (SB) (12069)', secondsFromStart: 105 },
    ...
    { stopId: 'TL-201', name: 'Research Dr at Nanaline Duke Bldg (Northbound)', secondsFromStart: 558 },
    { stopId: 'TL-202', name: 'LaSalle St at Circuit Lot (12102)', secondsFromStart: 629 },
    { stopId: 'TL-203', name: 'LaSalle St at Belmont Apartments (Northbound)', secondsFromStart: 843 },
  ],
  ...
  'TL-19': [
    ...
    { stopId: 'TL-208', name: 'Morreene Rd at Campus Walk Ave (SB) (12069)', secondsFromStart: 180 },
    ...
    { stopId: 'TL-217', name: 'Research Dr at Nanaline Duke Bldg (Northbound)', secondsFromStart: 720 },
    ...
    { stopId: 'TL-220', name: 'Research Dr at Erwin Rd (Research Drive Garage)', secondsFromStart: 900 },
    { stopId: 'TL-221', name: 'Erwin Rd at LaSalle St (Westbound)', secondsFromStart: 960 },
    { stopId: 'TL-222', name: 'LaSalle St at Belmont Apartments (Northbound)', secondsFromStart: 1020 },
  ],
};
